        ...
        {data.length ? (
          <ul role="list" className=" mt-10">
            {data.map((project) => (
              <li
                key={project._id}
                className="flex justify-between gap-x-6 px-5 py-10 mt-5 bg-white shadow-lg"
              >
                <div className="flex min-w-0 gap-x-4">
                  <div className="min-w-0 flex-auto space-y-2">
                    <div className="mb-2">
                      ...
                      <p className="font-bold text-xs uppercase bg-indigo-50 text-green-500 border-2 border-green-500 rounded-lg inline-block py-1 px-5">Colaborador</p>
                    )}
                    </div>
                    <Link
